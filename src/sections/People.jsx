...
const PeopleProducts = ({ onAddToCart }) => {
    return (
        <>
        <section className="products-section py-5">
        <div className="container">
        <div className="mb-3">
        <h1 className="fw-bold products-h1">People Also Buy</h1>
        </div>
        ...
        <Link to="/landing3" className="btn btn-outline-success mt-3 mt-md-0 product-btn p-3 mx-auto mx-md-0">
        Browse All
        </Link>
        </div>    

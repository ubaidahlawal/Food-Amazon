...
const SimilarProducts = ({ onAddToCart }) => {
    ...
    return (
        ...
        <div className="mb-3">
        <h1 className="fw-bold products-h1">Similar Products</h1>
        </div>
        ...
        <button className="btn btn-outline-success mt-3 mt-md-0 product-btn p-3 mx-auto mx-md-0">
        Browse All
        </button>
        </div>    
...
//                   <div className="mt-4">
//                     <div className="d-flex justify-content-between align-items-center mb-1">
//                       <small className="text-muted">Food Item</small>
//                       <img src={HeartImg} alt="heart" loading="lazy" />
//                     </div>

//                     <h5 className="fw-bold mb-2 product-name mt-2">
//                       {product.name}
//                     </h5>
...
//                     <button
//                       className="btn btn-outline-success w-100 mt-3 p-3 p-btn"
